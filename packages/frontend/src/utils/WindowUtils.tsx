...
export const showEditPrompt = (
  ...
  let newValue = window.prompt(
    "Enter the new value or preess cancel/esc to exit.",
    defaultValue
  );
  if (
    newValue === null ||
    newValue.toLowerCase() === defaultValue.toLowerCase()
  )
    return undefined;
  const confirmed = window.confirm(
    `Are you sure you would like to make the following changes?\n\n${defaultValue} => ${newValue}`
  );
...
export const showConfirmPrompt = (message: string): boolean => {
