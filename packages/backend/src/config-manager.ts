...
export class ConfigManager {
    ...
    public async initialize(): Promise<void> {
        ...
        // Create app config
        const appConfigResult: ConfigIOResult = await ConfigurationUtilities.createIfNotExistsAndLoad<AppConfig>(
            AppConfig,
            [
        ...
        const imagesConfigResult: ConfigIOResult = await ConfigurationUtilities.createIfNotExistsAndLoad<ImagesConfig>(
            ImagesConfig,
            [
        ...
        const troubleshootingConfigResult: ConfigIOResult = await ConfigurationUtilities.createIfNotExistsAndLoad<TroubleshootingKeywords>(
